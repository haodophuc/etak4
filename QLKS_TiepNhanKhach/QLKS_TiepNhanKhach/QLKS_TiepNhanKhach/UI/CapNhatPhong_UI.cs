    ...
    public partial class CapNhatPhong_UI : UserControl
    {
        ...
        private void LoadGrid()
        {
            try
            {
                ...
                bindingSource_Phong.DataSource = dTablePhong;
                bindingNavigator_Phong.BindingSource = bindingSource_Phong;
                grdCtrl_CapNhatPhong.DataSource = bindingNavigator_Phong.BindingSource;
            }

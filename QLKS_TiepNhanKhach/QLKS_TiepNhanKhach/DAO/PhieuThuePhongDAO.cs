...
namespace QLKS_TiepNhanKhach.DAO
{
    class PhieuThuePhongDAO
    {
        ...
        public DataTable SelectAllwithDaTraPhongByFalseAndMaKhachHang(int makhachhang)
        {
            try
            {
                string query = " SELECT 'P' + REPLACE(STR(MA_PHIEU,4),' ','0') AS MaP," +
                               ...
                               "NGAY_NHAN_PHONG,NGAY_TRA_PHONG,GHI_CHU,THANH_TOAN_TIEN_PHONG,THANH_TOAN_DICH_VU,DA_TRA_PHONG " +
                               "FROM PHIEU_THUE_PHONG " +
                               "WHERE DA_TRA_PHONG=0 AND MA_KHACH_HANG=@MA_KHACH_HANG";
        ...
        public DataTable SelectAllwithDaTraPhongByFalseAndMaDoanKhach(int maDoanKhach)
        {
            try
            {
                string query = " SELECT 'P' + REPLACE(STR(MA_PHIEU,4),' ','0') AS MaP," +
                               ...
                               "NGAY_NHAN_PHONG,NGAY_TRA_PHONG,GHI_CHU,THANH_TOAN_TIEN_PHONG,THANH_TOAN_DICH_VU,DA_TRA_PHONG " +
                               "FROM PHIEU_THUE_PHONG " +
                               "WHERE DA_TRA_PHONG=0 AND MA_DOAN_KHACH=@MA_DOAN_KHACH";

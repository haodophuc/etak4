...
IF EXISTS(SELECT 1 FROM sys.objects WHERE type = 'P')
	DROP PROCEDURE SP_INSERT_PHIEU_DAT_PHONG
GO
...
CREATE PROCEDURE SP_INSERT_PHIEU_DAT_PHONG
@IDENTITY INT OUT,
@MA_KHACH_HANG INT,
@MA_DOAN_KHACH INT,
@TIEN_COC MONEY
AS
BEGIN
	INSERT INTO PHIEU_DAT_PHONG(MA_KHACH_HANG, MA_DOAN_KHACH, TIEN_COC)
	VALUES (@MA_KHACH_HANG, @MA_DOAN_KHACH, @TIEN_COC)
	SET @IDENTITY = SCOPE_IDENTITY();
END
GO

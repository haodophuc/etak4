...
IF EXISTS(SELECT 1 FROM sys.objects WHERE type = 'P')
	DROP PROCEDURE SP_PHIEU_DANG_KY_DICH_VU_VA_DICH_VU
GO
...
BEGIN
SELECT *
FROM PHIEU_DANG_KY_DICH_VU
END
GO

-------- SP_PHIEU_DANG_KY_DICH_VU_VA_DICH_VU ------
CREATE PROCEDURE SP_PHIEU_DANG_KY_DICH_VU_VA_DICH_VU
AS
BEGIN
SELECT *
FROM PHIEU_DANG_KY_DICH_VU A INNER JOIN DICH_VU B ON A.MA_DICH_VU = B.MA_DICH_VU
END
GO
